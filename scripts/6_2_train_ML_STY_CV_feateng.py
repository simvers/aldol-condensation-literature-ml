...
# TCV_TYPE = 'stratified'
# MODEL_TO_TRAIN = ['lgbm_reg_nogroup']
...
if __name__ == "__main__":
    ...
    preprocessor = ml_training.build_preprocessor(numerical_cols, categorical_cols, drop_columns=['Ac_source_MAc', 'Ac_source_EAc'])
    ...
    for model in MODEL_TO_TRAIN:
        ...
        # Figure directory
        FIGURE_DIR = ROOT / f"figures/ML_STY/CV_feateng/{model}"
