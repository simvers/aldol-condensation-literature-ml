...
def calculate_molarflowrates(conditions):
    ...
    ac_properties = pd.read_json('data/raw/mol_properties/ac_properties.json')
    fa_properties = pd.read_json('data/raw/mol_properties/fa_properties.json')
    stab_properties = pd.read_json('data/raw/mol_properties/stab_properties.json')
...
if __name__ == "__main__":
    ...
    ac_properties.to_json('data/raw/mol_properties/ac_properties.json')
    ...
    fa_properties.to_json('data/raw/mol_properties/fa_properties.json')
    ...
    stab_properties.to_json('data/raw/mol_properties/stab_properties.json')
